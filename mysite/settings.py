...
SECRET_KEY = 'django-insecure-73l$p3f%dvq*pdtgazp@%=uns+v^$(t9ga*l^h(bf#(889^(6i'
...
MIDDLEWARE = [
    ...
    'django.middleware.clickjacking.XFrameOptionsMiddleware',# after SecurityMiddleware
    # ... your other middleware
]

ALLOWED_HOSTS = ['*']  # Temporary for testing. Later, replace '*' with your Render URL.
